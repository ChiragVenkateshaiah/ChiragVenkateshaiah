...
## Featured projects
- [databricks](https://github.com/ChiragVenkateshaiah/databricks_nyctaxi_project.git) — End-to-end data ingestion & transformation (Databricks + GitHub).
- [sql-scripts](https://github.com/ChiragVenkateshaiah/dvdrental-project.git) — SQL queries on dvdrental project 
